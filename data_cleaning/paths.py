...
mimic_iv_path = '/data/cb/scratch/sophia/rsidata/physionet.org/files/mimic-iv-ed/2.2/'
...
data_path = '/data/cb/scratch/sophia/rsidata/mimic-iv-ed/processed/mimic4ed/'
